    ...
    <>
      ...
      onSwiper={(swiper) => console.log(swiper)}
        ...
        >
          ...
          <SwiperSlide className='my-swipper-slide s1'>
            <div className="slidy">
            <img src={b} alt="Image 1" />
            <h3>Seafty & Creativity the Core of every project</h3>

            </div>

          </SwiperSlide>

          <SwiperSlide className='my-swipper-slide s2'>
          <div className="slidy">
            <img src={c} alt="Image 2" />
              <h3>Trust our team bring you vision to life</h3>
              </div>
          </SwiperSlide>

          <SwiperSlide className='my-swipper-slide s3'>
          <div className="slidy">
            <img src={d} alt="Image 2" />
        <h3>the third slide</h3>
            </div>
          </SwiperSlide>
